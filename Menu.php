...
class Menu extends \Piwik\Plugin\Menu
{
	...
	$menu->addItem('Tests AB','',$this->urlForAction('index')); 
	$menu->addItem('Tests AB','Lista tests',$this->urlForAction('recuperarTests'));
	$menu->addItem('Tests AB','Añadir test',$this->urlForAction('anhadirTest'));
