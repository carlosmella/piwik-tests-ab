...
namespace Piwik\Plugins\TestsAB\Reports;
 ...
 */
class GetTestAB extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('TestsAB_TestAB');
        $this->dimension     = null;
	...
	$this->parameters = array();
        ...
        // $this->widgetTitle  = 'TestsAB_TestAB';
    }
	...
	$view->config->columns_to_display = array_merge(array('label','Antes','Despues'));
    ...
    {
        $view = new View('@TestsAB/getTestAB');
        $view->myData = array();
